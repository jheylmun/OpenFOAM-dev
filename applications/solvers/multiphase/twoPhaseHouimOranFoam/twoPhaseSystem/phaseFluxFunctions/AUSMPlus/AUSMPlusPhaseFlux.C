...
)
{
    ...
    scalar xi = 3.0/16.0;
    surfaceScalarField Kp(0.25 + 0.75*(1.0 - zeta/2.0));
    surfaceScalarField Ku(0.75 + 0.25*(1.0 - zeta/2.0));
    surfaceScalarField sigma(0.75*zeta/2.0);
