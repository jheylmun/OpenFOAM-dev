...
#include "phaseMeanVelocityForce.H"
...
namespace fv
{
    defineTypeNameAndDebug(phaseMeanVelocityForce, 0);

    addToRunTimeSelectionTable
    (
        option,
        phaseMeanVelocityForce,
        dictionary
    );
}
}
...
void Foam::fv::phaseMeanVelocityForce::writeProps
(
    const scalar gradP
) const
{
...
Foam::fv::phaseMeanVelocityForce::phaseMeanVelocityForce
(
...
void Foam::fv::phaseMeanVelocityForce::correct(volVectorField& U)
{
...
void Foam::fv::phaseMeanVelocityForce::addSup
(
    fvMatrix<vector>& eqn,
    const label fieldI
)
...
void Foam::fv::phaseMeanVelocityForce::constrain
(
    fvMatrix<vector>& eqn,
    const label
)
